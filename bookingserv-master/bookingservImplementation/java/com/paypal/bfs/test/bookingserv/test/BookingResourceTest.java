...
class BookingResourceTest extends BaseTestController {
	...
	@Test
	   public void _01_allBooking() throws Exception {
		...
		MvcResult result = mvc.perform(get("/v1/bfs/booking")).andExpect(status().isOk()).andReturn();
	...
	public void _02_createBooking() throws Exception {
        ...
        MvcResult result = mockMvc.perform(post("/v1/bfs/booking").content(serilizeToJSON(entity)).contentType(contentType))
